...
class SimInfo:
    def __init__(self):
        _acpmf_physics = mmap.mmap(0, ctypes.sizeof(SPageFilePhysics), "acpmf_physics")
        _acpmf_graphics = mmap.mmap(0, ctypes.sizeof(SPageFileGraphic), "acpmf_graphics")
        _acpmf_static = mmap.mmap(0, ctypes.sizeof(SPageFileStatic), "acpmf_static")
        ...
        self.state = (_acpmf_physics.read(),_acpmf_graphics.read(),_acpmf_static.read())
